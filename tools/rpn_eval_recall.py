...
import _init_paths
from model.test_rpn_eval import test_net_rpn_eval
...
if __name__ == '__main__':
  ...
  if args.model:
    model_path = os.path.join('output/vgg16/voc_2007_trainval', filename+'.ckpt')
  ...
  for max_per_image in [300, 1000, 2000]:
    print('max_per_image is {}'.format(max_per_image))
    test_net_rpn_eval(sess, net, imdb, filename, max_per_image=max_per_image)
